  ...
  <div className="aboutSection">
    <div className="background">
      ...
      >
        ...
        in computer science. I love learning new things, especially if it
        involves software engineering. I love developing and creating new
        things. I am also a professional (self-proclaimed) musician, with
        mastery at the guitar and piano.
      </motion.p>
    </div>
  </div>
);
